...
const I18N = {
  ...
  _translations: {
    ko: {
      ...
      'social.compose.placeholder': '무슨 생각을 하고 있나요? 실명이 자동으로 사용됩니다.',
      'social.compose.media': '이미지/영상 URL (선택)',
      'social.like': '좋아요',
      'social.comment.count': '댓글',
      'social.comment.placeholder': '댓글 달기... (실명으로 작성됩니다)',
      'social.reply.placeholder': '답글 달기...',
      'social.empty': '아직 게시물이 없어요. 첫 번째로 소통을 시작해보세요!',
      'social.name.label': '실명으로 작성됩니다',

      // Item comments
      'item.comments': '댓글',
      'item.comment.placeholder': '이 아이템에 대한 댓글을 달아보세요...',
      'item.comments.empty': '아직 댓글이 없어요. 첫 댓글을 남겨보세요!',
      'item.view.content': '내용',
      ...
      // Admin users
      'admin.users.add': '계정 추가',
      'admin.users.name': '이름',
      'admin.users.school': '학교',
      'admin.users.role': '역할',
    ...
    en: {
      ...
      'social.compose.placeholder': "What's on your mind? Your real name will be used.",
      'social.compose.media': 'Image/Video URL (optional)',
      'social.like': 'Like',
      'social.comment.count': 'Comments',
      'social.comment.placeholder': 'Add a comment... (your real name will be shown)',
      'social.reply.placeholder': 'Write a reply...',
      'social.empty': 'No posts yet. Be the first to connect!',
      'social.name.label': 'Posted with real name',

      'item.comments': 'Comments',
      'item.comment.placeholder': 'Add a comment about this item...',
      'item.comments.empty': 'No comments yet. Be the first!',
    ...
    ja: {
      ...
      'social.compose.placeholder': '今何を考えていますか？本名が使用されます。',
      'social.compose.media': '画像・動画URL（任意）',
      'social.like': 'いいね',
      'social.comment.count': 'コメント',
      'social.comment.placeholder': 'コメントを追加...（本名が表示されます）',
      'social.reply.placeholder': '返信を入力...',
      'social.empty': 'まだ投稿がありません。最初に交流を始めましょう！',
      'social.name.label': '本名で投稿されます',

      'item.comments': 'コメント',
      'item.comment.placeholder': 'このアイテムにコメントしましょう...',
      'item.comments.empty': 'まだコメントがありません。最初のコメントを！',
      'item.view.content': '内容',

      'hero.badge': '学校文化交流プラットフォーム',
      'hero.login.title': 'ログインして始めよう',
      'hero.login.desc': '学校のカルチャーボックスを探索・作成・交流しましょう！',
      'hero.login.btn': '今すぐログイン →',
      'how.login.title': '学校ログイン',
      'how.login.desc': '学校のアカウントでログインして学校のボックスを見ましょう',
      ...
      'admin.users.add': 'アカウント追加',
      'admin.users.name': '名前',
      'admin.users.school': '学校',
      'admin.users.role': '役割',

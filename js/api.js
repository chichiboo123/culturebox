...
const API = {
    ...
    switch (action) {
      ...
      case 'addMessage': {
        const newMsg = {
          ...
          user_name: params.user_name || DataStore.currentUser?.name || 'Anonymous',
  ...
  createBox: (data) => API._fetch('createBox', data),
  updateBox: (data) => API._fetch('updateBox', data),
  addItem: (data) => API._fetch('addItem', data),
  removeItem: (id) => API._fetch('removeItem', { id }),
  addMessage: (data) => API._fetch('addMessage', data),
  updateMessageStatus: (id, status) => API._fetch('updateMessageStatus', { id, status }),
  sendBox: (id) => API._fetch('sendBox', { id }),
  openBox: (id) => API._fetch('openBox', { id }),
  deleteBox: (id) => API._fetch('deleteBox', { id }),
  updateMessage: (id, content) => API._fetch('updateMessage', { id, content }),
  deleteMessage: (id) => API._fetch('deleteMessage', { id }),

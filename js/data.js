/**
 * Digital Culture Box - Demo Data & Data Store
 * In production, this data comes from Google Sheets via Apps Script.
 * This file provides demo data for the prototype and acts as the local data store.
 */
const DataStore = {
  schools: [
  ...
  boxes: [
    {
      id: 'box_01',
      title: '우리 학교 급식 대탐험',
      title_en: 'Our School Lunch Adventure',
      title_ja: '私たちの給食大冒険',
      description: '한국 학교 급식의 다양한 메뉴들을 소개합니다! 김치, 비빔밥, 떡볶이까지!',
      description_en: 'Introducing the diverse menus of Korean school lunches! From kimchi to bibimbap!',
      description_ja: '韓国の給食メニューを紹介します！キムチからビビンバまで！',
      from_school_id: 'sch_01',
      to_school_id: 'sch_02',
      status: 'arrived',
      cover_image_url: '',
      created_by: 'user_01',
    ...
    {
      id: 'box_02',
      title: 'Tokyo Street Fashion',
      title_en: 'Tokyo Street Fashion',
      title_ja: '東京ストリートファッション',
      description: '東京の学生たちのファッションを紹介します。制服からカジュアルまで！',
      description_en: 'Introducing Tokyo student fashion! From uniforms to casual styles!',
      description_ja: '東京の学生たちのファッションを紹介します。制服からカジュアルまで！',
      from_school_id: 'sch_02',
      to_school_id: 'sch_01',
      status: 'arrived',
      cover_image_url: '',
      created_by: 'user_02',
    ...
    {
      id: 'box_03',
      title: 'Brooklyn Art & Music',
      title_en: 'Brooklyn Art & Music',
      title_ja: 'ブルックリンアート＆ミュージック',
      description: 'Discover the vibrant art and music scene at our school! Murals, band practice, and more.',
      description_en: 'Discover the vibrant art and music scene at our school! Murals, band practice, and more.',
      description_ja: '私たちの学校のアートと音楽シーンを紹介！',
      from_school_id: 'sch_03',
      to_school_id: 'sch_04',
      status: 'sent',
      cover_image_url: '',
      created_by: 'user_03',
    ...
    },
    {
      id: 'box_04',
      title: '부산의 바다와 축제',
      title_en: 'Busan: Ocean & Festivals',
      title_ja: '釜山の海と祭り',
      description: '부산 해운대 해수욕장, 자갈치 시장, 그리고 학교 축제를 소개합니다!',
      description_en: 'Introducing Haeundae Beach, Jagalchi Market, and our school festival!',
      description_ja: '海雲台ビーチ、チャガルチ市場、学校祭りを紹介！',
      from_school_id: 'sch_04',
      to_school_id: 'sch_03',
      status: 'opened',
      cover_image_url: '',
      created_by: 'user_04',
    ...
    },
    {
      id: 'box_05',
      title: '한국의 전통 놀이',
      title_en: 'Korean Traditional Games',
      title_ja: '韓国の伝統的な遊び',
      description: '윷놀이, 제기차기, 팽이치기 등 한국의 전통 놀이를 알려드려요.',
      description_en: 'Learn about Korean traditional games like Yutnori and Jegichagi!',
      description_ja: 'ユンノリやチェギチャギなど韓国の伝統遊びを紹介！',
      from_school_id: 'sch_01',
      to_school_id: 'sch_03',
      status: 'draft',
      cover_image_url: '',
  ...
  messages: [
    { id: 'msg_01', box_id: 'box_01', user_id: 'user_02', user_name: 'Yuki', user_school: 'sch_02', content: 'すごい！韓国の給食はとても美味しそうですね！日本の給食と比べてみたいです。', parent_id: null, status: 'approved', created_at: '2026-02-26T10:30:00' },
    { id: 'msg_02', box_id: 'box_01', user_id: 'user_01', user_name: '민지', user_school: 'sch_01', content: '고마워요! 일본 급식도 궁금해요. 특히 카레가 유명하다고 들었어요!', parent_id: 'msg_01', status: 'approved', created_at: '2026-02-26T11:15:00' },
    { id: 'msg_03', box_id: 'box_01', user_id: 'user_02', user_name: 'Haruto', user_school: 'sch_02', content: 'The chicken looks amazing! Do you eat it every day?', parent_id: null, status: 'approved', created_at: '2026-02-27T09:00:00' },
    { id: 'msg_04', box_id: 'box_04', user_id: 'user_03', user_name: 'Emma', user_school: 'sch_03', content: 'Busan looks beautiful! I want to visit Haeundae beach someday!', parent_id: null, status: 'approved', created_at: '2026-02-21T14:00:00' },
    { id: 'msg_05', box_id: 'box_04', user_id: 'user_04', user_name: '서연', user_school: 'sch_04', content: 'Thank you Emma! You should come in summer, it\'s the best season!', parent_id: 'msg_04', status: 'approved', created_at: '2026-02-21T15:30:00' },
  ],
  ...
  reactions: [
    ...
    { id: 'rct_03', target_type: 'message', target_id: 'msg_01', user_id: 'user_01', type: 'thanks' },
    { id: 'rct_04', target_type: 'item', target_id: 'itm_09', user_id: 'user_03', type: 'surprise' },
  ],
  ...
  getBoxMessages(boxId) {
    return this.messages.filter(m => m.box_id === boxId && m.status === 'approved').sort((a, b) => new Date(a.created_at) - new Date(b.created_at));
  },
